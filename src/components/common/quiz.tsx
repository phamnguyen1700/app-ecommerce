...
export const quizData = [
  ...
  {
    question:
      "Hai đến ba giờ sau khi bôi kem nền, lớp trang điểm của bạn trở nên?",
    answers: [
  ...
  return (
    <>
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        <DrawerContent className="w-full sm:w-[450px] h-full fixed right-0 top-0 rounded-none overflow-y-auto overflow-x-hidden z-[500]">
          <DrawerHeader>
